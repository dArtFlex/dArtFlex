...
export default function PrivacyPolicy() {
  ...
  return (
    <PageWrapper className={classes.privacyPolicyWrapper}>
      <>
        ...
        <Box className={classes.textBlock}>
          ...
          <Typography variant={'body2'}>
            ...
            “agree” to this Policy when prompted), you agree to the terms of this Policy on behalf of yourself or the
            entity or organization that you represent. If you do not agree to any term in this Policy, you should
            refrain from further use of our Services.
          </Typography>
          <Typography className={classes.sectionTitle}>Types of Data We Collect.</Typography>
          <Typography variant={'body2'}>
            “Personal Data” means data that allows someone to identify or contact you, including, for example, your
            name, e-mail address, as well as any other non-public information about you that is associated with or
            linked to any of the foregoing data. “Anonymous Data” means data, including aggregated and de-identified
            data, that is not associated with or linked to your Personal Data; Anonymous Data does not, by itself,
            permit the identification of individual persons. We collect Personal Data and Anonymous Data, as described
            below.
          </Typography>
          ...
          <ol className={classes.sectionList}>
            ...
            <li>
              <Typography variant={'body2'} component={'span'}>
                ...
                on the website, we will collect your email address (required field) and name (not required field) in
          ...
          <Typography variant={'body2'}>
            ...
            In particular, MetaMask and other wallets provide us with your Ethereum address and certain other
            information you choose to share with MetaMask and other wallets. These third-party companies may supply us
            with Personal Data. We may add this to the information we have already collected from you via our Service to
            improve it. We do not collect Personal Data automatically, but we may tie the information that we collect
            automatically to Personal Data about you that we collect from other sources or that you provide to us.
          </Typography>
          ...
          <ol className={classes.sectionList}>
            ...
            <li className={classes.unorderedListItem}>
              <Typography variant={'body2'} component={'span'}>
                We may use your Personal Data to contact you about our own and third parties’ goods and services that
                may be of interest to you.
              </Typography>
            </li>
            <li className={classes.unorderedListItem}>
              <Typography variant={'body2'} component={'span'}>
                Anonymous Data. We may create Anonymous Data records from Personal Data by excluding information (such
                as your name) that makes the data personally identifiable to you. We use this Anonymous Data to analyze
          ...
          <Typography variant={'body2'}>
            ...
            control over, do not review, and cannot be responsible for, these outside websites or their content. Please
            be aware that the terms of this Privacy Policy do not apply to these outside websites or content, or to any
          ...
          <Typography variant={'body2'}>
            ...
            limited to) MetaMask; your interactions with MetaMask and/or any third-party electronic wallet extensions
            are governed by the applicable privacy policies. In the case of MetaMask, its privacy policy is available
            here.
          </Typography>
          ...
          <Typography variant={'body2'}>
            ...
            to prompt you before accepting a Cookie from the websites you visit. Consult your browser’s technical
            information. If you do not accept Cookies, however, you may not be able to use all portions of the Service
            or all functionality of the Service. If you have any questions about how to disable or modify Cookies,
            please let us know at the address given in paragraph (1).
          </Typography>
          ...
          <Typography variant={'body2'}>
            ...
            however, retain Personal Data for an additional period as is permitted or required under applicable laws,
          ...
          <Typography variant={'body2'}>
            ...
            safeguards to preserve the integrity and security of all information collected through our website. However,
            no security system is impenetrable and we cannot guarantee the security of our systems 100%. In the event
            that any information under our control is compromised as a result of a breach of security, we will take
          ...
          <Typography variant={'body2'}>
            ...
            submits Personal Data to dArtFlex and we learn that the Personal Data is the information of a child under
            13, we will attempt to delete the information as soon as possible. If you believe that we might have any
            Personal Data from a child under 13, please contact us via{' '}
            <Link href={'#'} className={classes.navLink}>
              ”Contact us” form
            </Link>{' '}
          ...
          <Typography variant={'body2'}>
            ...
            other countries, including the United States, where laws regarding the processing of Personal Data may be
            less stringent than the laws in your country. By providing your data, you consent to such a transfer.
          </Typography>
